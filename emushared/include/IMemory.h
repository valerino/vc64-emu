...
public:
     ...
     */
    virtual uint8_t readByte(uint16_t address, uint8_t* b) = 0;
    /**
     ...
     * @return 0 on success, or errno
     */
    virtual uint16_t readWord(uint16_t address, uint16_t* w) = 0;
     ...
     * @return 0 on success, or errno
     */
    virtual int writeByte(uint16_t address, uint8_t b) = 0;
     ...
     * @return 0 on success, or errno
     */
    virtual int writeWord(uint16_t address, uint16_t w) = 0;
     ...
     * @return 0 on success, or errno
     */
    virtual int writeBytes(uint16_t address, uint8_t* b, uint16_t size) = 0;
